...
while(run):
    #Se avisa del comienza de la partida al servidor Intermedio
    ...
    if(response=='OK'):
        ...
        while(jugar):
            ...
            #Recibir jugada del bot en formato Jugada|Resultado(GANAR, PERDER, EMPATE)|Puntos jugador|Puntos bot|Estado final(WIN, LOSE, SEGUIR)
